    ...
    public void numS2() {
        ...
        ViewInteraction calculatorEditText = onView(
                allOf(withId(R.id.formula),
                        ...
                        isDisplayed()));
        calculatorEditText.perform(replaceText("5"), closeSoftKeyboard());
        ...
        ViewInteraction calculatorEditText2 = onView(
                allOf(withId(R.id.formula), withText("5"),
                        withParent(withId(R.id.display)),
                        isDisplayed()));
        calculatorEditText.perform(replaceText("51"), closeSoftKeyboard());
        ...
        ViewInteraction calculatorEditText3 = onView(
                allOf(withId(R.id.formula), withText("51"),
                        withParent(withId(R.id.display)),
                        isDisplayed()));
        calculatorEditText.perform(replaceText("514"), closeSoftKeyboard());
        ...
        ViewInteraction calculatorEditText4 = onView(
                allOf(withId(R.id.formula), withText("514"),
                        withParent(withId(R.id.display)),
                        isDisplayed()));
        calculatorEditText.perform(replaceText("5142"), closeSoftKeyboard());
        ...
        ViewInteraction calculatorEditText5 = onView(
                allOf(withId(R.id.formula), withText("5142"),
                        withParent(withId(R.id.display)),
                        isDisplayed()));
        calculatorEditText.perform(replaceText("5142−"), closeSoftKeyboard());
        ...
        ViewInteraction calculatorEditText6 = onView(
                allOf(withId(R.id.formula), withText("5142−"),
                        withParent(withId(R.id.display)),
                        isDisplayed()));
        calculatorEditText.perform(replaceText("5142−6"), closeSoftKeyboard());
        ...
        ViewInteraction calculatorEditText7 = onView(
                allOf(withId(R.id.formula), withText("5142−6"),
                        withParent(withId(R.id.display)),
                        isDisplayed()));
        calculatorEditText.perform(replaceText("5142−67"), closeSoftKeyboard());
        ...
        ViewInteraction calculatorEditText8 = onView(
                allOf(withId(R.id.formula), withText("5142−67"),
                        withParent(withId(R.id.display)),
                        isDisplayed()));
        calculatorEditText.perform(replaceText("5142−679"), closeSoftKeyboard());

        ViewInteraction editText = onView(
                allOf(withId(R.id.result), withText("4463"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        editText.check(matches(withText("4463")));
