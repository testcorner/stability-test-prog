 ...
 * @since 4.5
 */
public class GTTestRunner extends ParentRunner<FrameworkMethod> {
     ...
     */
    public GTTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
    ...
    protected List<FrameworkMethod> getChildren() {
        // System.out.println(getTestClass().getAnnotatedMethods(Random.class));
        // if (getTestClass().getAnnotatedMethods(Random.class).isEmpty())
        Bundle extras = InstrumentationRegistry.getArguments();
       if(extras.containsKey("r"))
        {
            return computeRandomMethods();
        }
        else
       {
